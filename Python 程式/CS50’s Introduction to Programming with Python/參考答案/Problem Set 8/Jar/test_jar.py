# Implement, in a file called test_jar.py, four or more functions that collectively test your implementation
# of Jar thoroughly, each of whose names should begin with test_
