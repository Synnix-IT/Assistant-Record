...
from PyQt6.QtWidgets import QToolButton,QMainWindow,QVBoxLayout,QHBoxLayout,QApplication,QWidget,QToolBar,QMenu,QLabel
import os
...
class ToolButtonDemo(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        tool_button_pic.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        layout.addWidget(tool_button_pic)

        # 工具按钮+箭头
        tool_button_arrow = QToolButton(self)
        tool_button_arrow.setText("工具按钮-箭头")
        tool_button_arrow.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonTextBesideIcon)
        tool_button_arrow.setArrowType(Qt.ArrowType.UpArrow)
        ...
        tool_button_menu.setPopupMode(QToolButton.ToolButtonPopupMode.InstantPopup)
