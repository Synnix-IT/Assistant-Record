...
from PyQt6.QtWidgets import QApplication, QLineEdit, QWidget, QFormLayout,QPushButton,QLabel
import sys
...
class lineEditDemo(QWidget):
    def __init__(self, parent=None):
        ...
        lineEdit_normal.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        lineEdit_color.setAlignment(Qt.AlignmentFlag.AlignLeft)
        ...
        lineEdit_cursor.setCursorPosition(0)
    ...
    def move_cursor(self):
        # 移动光标
        self.lineEdit_cursor.cursorForward(True,1)
        pass
